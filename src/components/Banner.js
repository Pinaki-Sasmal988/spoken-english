...
export default function Banner() {
    ...
    return (
    <div className="containers p-0 mb-3">
    <div className="owl-carousel  position-relative header-carousel">
        <div className="owl-carousel-item position-relative">
            <img className="img-fluid" src="img/banner3.jpeg" alt="" />
            <div className="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style={{background:'rgba(24, 29, 56, .4)'}}>
                <div className="container">
                    <div className="row justify-content-start">
                        <div className="col-sm-10 col-lg-8">
                            <h5 className="text-white text-uppercase mb-3 animated slideInDown">Best Offline Spoken English Institude At Kakdwip </h5>
        ...
        <div className="owl-carousel-item position-relative">
            <img className="img-fluid" src="img/banner2.jpeg" alt="" />
            <div className="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style={{background:'rgba(24, 29, 56, .4)'}}>
                <div className="container">
                    <div className="row justify-content-start">
                        <div className="col-sm-10 col-lg-8">
